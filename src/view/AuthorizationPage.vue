  ...
  methods: {
    async userLogin() {
      ...
      if (!this.v$.$error) {
        ...
        const url = "http://localhost:8080/web_4_spring/api/auth/login";
    ...
    async userRegister() {
      ...
      if (!this.v$.$error) {
        const user = {username: this.event.login, password: this.event.password}
        const url = "http://localhost:8080/web_4_spring/api/auth/register";
  ...
  <div class="container" id="container">
	<div class="form-container sign-up-container">
		<form @submit.prevent>
			...
			<custom-button id="password" @click="userRegister()">Register</custom-button>
		</form>
	</div>
	<div class="form-container sign-in-container">
		<form @submit.prevent>
			...
			<custom-button id="login" @click="userLogin">Login</custom-button>
		</form>
	</div>
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				<h1>Welcome Back!</h1>
				<p>If you already have account, sing in to countinue!</p>
				<button class="ghost" id="signIn">Sign In</button>
			</div>
			<div class="overlay-panel overlay-right">
				<h1>Hello, Friend!</h1>
				<p>If you haven`t account, you can register it now!</p>
